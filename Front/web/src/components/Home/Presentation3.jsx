            ...
            <div className='contenedor_presentacion_3'>
                <div>
                    ...
                    <div className='cards'>
                        <div className='icon_con_texto'>
                            ...
                            <h1 className='texto_en_card'>Reserva lugares</h1>
                        </div>
                        <div className='icon_con_texto'>
                            <img src={People_light} alt='People_light' />
                            <h1 className='texto_en_card'>Conoce Gente</h1>
                        </div>
                        <div className='icon_con_texto'>
                            <img src={Place_light} alt='Place_light' />
                            <h1 className='texto_en_card'>Sin preocupaciones</h1>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className='cards'>
                        <div className='icon_con_texto'>
                            <img src={face_light} alt='face_light' />
                            <h1 className='texto_en_card'>Publica tu actividad</h1>
                        </div>
                        <div className='icon_con_texto'>
                            <img src={People_light} alt='People_light' />
                            <h1 className='texto_en_card'>Acepta reservas</h1>
                        </div>
                        <div className='icon_con_texto'>
                            <img src={Place_light} alt='Place_light' />
                            <h1 className='texto_en_card'>Gana dinero sin problemas</h1>
                        </div>
                    </div>
                </div>
            </div>
